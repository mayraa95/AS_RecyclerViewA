package com.mayaanugrahsyafira202102344.recyclerviewa;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nm.setNama("Albania");
        nm.setDeskripsi("Negara ini menggunakan bendera warna merah.");
